...
<body>
    <div class="container">
        ...
        <div class="footer">
            &copy; <?php echo e(date('Y')); ?> Yahya Haroun - Portfolio
        </div>
    </div>
</body>
</html>
<?php /**PATH /home/yahya-haroun/Bureau/.gemini/antigravity/scratch/yahya-portfolio/resources/views/emails/otp.blade.php ENDPATH**/ ?>